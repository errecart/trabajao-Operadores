...
// Libreria ======================================================================================
const cuentaCompleta = document.getElementById("enviar");
cuentaCompleta.addEventListener('click', completaAlert);

function completaAlert() {
  swal({
    title: "Felicitaciones",
    text: "Tu cuenta fue guardada",
    icon: "success",
    timer: 1800
  });
}
